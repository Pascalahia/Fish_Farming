...
function setOneText() {
  tank.setSupportLabelText(getNow(), "Tank one");
}
function setTwoText() {
  tank.setSupportLabelText(getNow(), "Tank two");
}
function setThreeText() {
  tank.setSupportLabelText(getNow(), "Tank three");
}
...
function enlarge() {
  document.getElementsByClassName('wrapper')[0].setAttribute("style", "width:400px;height:400px; position: fixed; right: 40%;");
  tank.redraw();
}
function high() {
